...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 px-15 py-30 font-['Founders-Grotesk']">
      <div className="w-1/2 h-full flex flex-col justify-between font-semibold">
        <div className="heading">
          <h1 className="text-[6vw] uppercase tracking-tight leading-none -mb-6">
            Eye-
          </h1>
          <h1 className="text-[6vw] uppercase tracking-tight leading-none -mb-6">
            Opening
      ...
      <div className="w-1/2">
        ...
        <div className="details font-['Neue-Montreal'] mt-10">
